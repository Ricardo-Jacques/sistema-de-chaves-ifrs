...
<head>
    ...
    <link rel="stylesheet" href="estilo/style_consulta_chave.css">
...
<body>
    ...
    <?php
        ...
        <th>Data de devolução</th><th>Hora de Devolução</th><th>Estado</th></tr>";

        $contador = 0;
        $consulta_sql = "SELECT nome, pessoa, data_retirada, hora_retirada, data_devolucao, 
        hora_devolucao, estado FROM chaves";
        ...
        while ($linha = mysqli_fetch_assoc($resultado_consulta)) {
            if ($contador % 2 == 0) {
                ...
                echo "<td class='cinza'>" . $linha['estado'] . "</td>";
                echo "</tr>";
                $contador = $contador + 1;
            } else {
                echo "<tr>";
                ...
                echo "<td class='verde'>" . $linha['estado'] . "</td>";
                echo "</tr>";
                $contador = $contador + 1;
            }
        }
